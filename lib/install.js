      ...
      if (dirs.length > 0) {
        ...
        async.each(
          ...
          function peerDependenciesInstalled(err) {
            ...
            util
              .dependencies
              .addPeerDependenciesToMain(backendPath)
              .then(function() {
                resolve();
              })
              .catch(reject);
        ...
        Promise
          ...
          .then(function runNpmTasksForModules() {
            ...
            npm.forEach(function(module) {
              actions.push(util.grunt.runTasks(backendPath.moduleDir, path.join(backendPath.moduleDir, backendPath.modulePath, module.name)));
            });
