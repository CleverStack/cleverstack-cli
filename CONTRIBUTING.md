...
4. Please follow the [coding guidelines](https://github.com/CleverStack/cleverstack-cli/blob/master/.jshintrc)
5. Push your changes and submit a [pull request](https://github.com/CleverStack/cleverstack-cli/compare/) to the master branch.
